...
<!-- <h2>Playlist de <?php echo htmlspecialchars($_SESSION["username"]); ?></h2>
  ...
  <br>
    ...
    <audio controls>  
      <source src="http://127.0.0.2:8001/<?php echo htmlspecialchars($_SESSION["username"]); ?>" type="audio/mp3">  
 ...
 -->
    ...
    <a href="start-liquidsoap.php"><button class='btn btn-primary'>Iniciar playlists</button></a>
    <a href="detener.php"><button class='btn btn-danger'>Parar playlist</button></a>
<!--
    <br>
</div>
