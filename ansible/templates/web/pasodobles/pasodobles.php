...
<h2>Playlist de Pasodobles</h2>

<br>

    <audio controls autoplay>  
      <source src="http://192.168.1.137:8001/pasodobles" type="audio/mp3">  
          ...
          while ($row = mysqli_fetch_assoc($resultado)) {
            ...
            printf(
              "<tr>
                ...
                <td>
                <a href='/music/pasodobles/".$cod."'download='".$cod."'>
